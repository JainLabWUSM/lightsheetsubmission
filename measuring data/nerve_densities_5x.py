...
search_power = search_vol * 3.66 * 3.66 * 2.885
sci_power = f"{search_power:e}"

glom_vol = count_positive_pixels(gloms)
glom_vol = glom_vol * 3.66 * 3.66 * 2.885
...
vals, depth = calculate_y_vals(isolated_nerves, search_region, 3.66)
...
excel_filename = 'y_depth_nerves.xlsx'
