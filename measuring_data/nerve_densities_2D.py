...
def nerve_twodim_calc(glom_name, nerve_name, xy_scale, search):

    #Convert voxel scaling to actual pixels to dilate
    dilate_xy = dilation_length_to_pixels(xy_scale, search)
    ...
    nerve_density_real = nerve_density * xy_scale * xy_scale
