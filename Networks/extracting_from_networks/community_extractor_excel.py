...
edges_df = pd.DataFrame(edges_largest_component, columns=["Column A", "Column B"])
...
print("Nodes in the selected connected component:", nodes_in_largest_component)
...
tifffile.imsave("isolated_community.tif", mask2)