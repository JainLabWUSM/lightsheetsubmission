...
def main(input_path):
    ...
    # Print and return the list of centroids
    for i, centroid in enumerate(centroids):
        print(f"ROI {i + 1} centroid: X={centroid[2]}, Y={centroid[1]}, Z={centroid[0]}")

    return centroids

def generate_excel_file(angles):
    """
    Generates an excel file from the info in a pairwise list.
    """
    
    # Prompt the user for the Excel file location
    excel_file_path = input("Enter the path to save the Excel file (including filename and extension): ")
...
def draw_rays(centroids, tiff_shape):
    """
    ...
    tiff_file_path = input("Enter the path to save the new binary TIFF file (including filename and extension): ")
...
if __name__ == "__main__":
    # Get paths to two binary TIFF files
    input_path_1 = input("Enter the path to the first binary TIFF stack: ")
    input_path_2 = input("Enter the path to the second binary TIFF stack: ")

    # Process the first TIFF file
    centroids_1 = main(input_path_1) #delete this block to speed up code.
    print("\nList of Centroids for the first TIFF file:")
    print(centroids_1)

    # Process the second TIFF file
    centroids_2 = main(input_path_2)
    print("\nList of Centroids for the second TIFF file:")
    print(centroids_2)
    ...
    # Print and return the list of centroid pairs
    print("\nList of Centroid Pairs:")
    for pair in centroid_pairs:
    ...
    # Print and return the list of angles
    print("\nList of Angles (Azimuthal, Polar):")
    for angle in angles:
        print(f"Azimuthal: {angle[0]}, Polar: {angle[1]}")

    # Generate Excel file from the angles list
    generate_excel_file(angles)
    ...
    #Make rays tiff
    draw_rays(centroid_pairs, tiff_shape)
