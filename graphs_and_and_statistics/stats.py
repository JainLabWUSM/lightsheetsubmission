...
def shapiro(alpha):
    ...
    #for i in range(len(data)): #Note this was only enabled for angles to shift the distribution into the same 0 to 2pi range
        #if data[i] < 2:
            #data[i] = data[i] + 6.28
...
def an(alpha):
    ...
    #Note this was only enabled for angles to shift the distribution into the same 0 to 2pi range
